...
public class FXMLVBoxMainAppController implements Initializable {
    ...
    @FXML
    private MenuItem menuItemGraficosOSporMes;
    ...
    @FXML
    void handleMenuItemRelatorioCliente() throws IOException {
        AnchorPane a = (AnchorPane) FXMLLoader.load(getClass().getResource("../view/FXMLAnchorPaneRelatorioCliente.fxml"));
        anchorPane.getChildren().setAll(a);
    }
    
    @FXML
    void handleMenuItemGraficosOSporMes() throws IOException {
        AnchorPane a = (AnchorPane) FXMLLoader.load(getClass().getResource("../view/FXMLAnchorPaneGraficosOSporMes.fxml"));
        anchorPane.getChildren().setAll(a);
    }
